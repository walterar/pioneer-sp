	...
	local makeCrewList = function ()
		...
		for crewMember in Game.player:EachCrewMember() do
			...
			crewTable:AddRow({
				...
				ui:Label(showCurrency(crewWage)):SetColor({ r = 0.0, g = 1.0, b = 0.2 }), -- green
				ui:Label(showCurrency(crewOwed)):SetColor({ r = 1.0, g = 0.0, b = 0.0 }), -- red
		...
		crewTable:AddRow({
			...
			ui:Label(showCurrency(wageTotal)):SetColor({ r = 0.0, g = 1.0, b = 0.2 }), -- green
			ui:Label(showCurrency(owedTotal)):SetColor({ r = 1.0, g = 0.0, b = 0.0 }), -- red
		})
